...
import Controller.category_DAO;
...
//        lb_MaSP.setFont(new Font("Arial", Font.PLAIN, 24)); // Đặt font mới với kích cỡ 24
        ...
        lb_NgayTao = new JLabel("Ngày tạo");

        cboTimKiem = new JComboBox(new String[]{"Mã loại", "Tên loại"});
        jd_ngayTao = new JDateChooser();
        jd_ngayTao.setDateFormatString("dd/MM/yyyy");
...
//        gbc.weighty = 1.0;  // Dãn ra theo chiều dọc
        ...
        panel_center.setPreferredSize(new Dimension(1120, 250));
        gbc = new GridBagConstraints();
...
//        gbc.gridy = 0;
//        gbc.insets = new Insets(10, 30, 10, 20);
//        panel_center.add(lb_NgayTao, gbc);
//        gbc.gridx = 5;
//        gbc.gridy = 0;
//        //jd_ngayTao.setColumns(13);
//        jd_ngayTao.setPreferredSize(new Dimension(120,20));
//        gbc.insets = new Insets(10, 30, 10, 20);
//        panel_center.add(jd_ngayTao, gbc);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (btn.equals(btnAdd)) {
            try {
                ...
                Logger.getLogger(View.category_form.class
