...
//        gbc.weighty = 1.0;  // Dãn ra theo chiều dọc
        ...
        panel_center.setPreferredSize(new Dimension(800, 250));
        gbc = new GridBagConstraints();
...
//        buttonPanel.setLayout(new GridLayout(1,4,10,10)); 1 hàng 4 cột k/c 10
        ...
        Paneltable.setPreferredSize(new Dimension(800, 300));
    }
        ...
        if (btn.equals(btnAdd)) {
            try {
                ...
                if (!kiemtra) { // kiemtra == false
                    ...
                    JOptionPane.showMessageDialog(null, "Mã sản phẩm đã tồn tại!", "Thông báo", JOptionPane.WARNING_MESSAGE);
